...
define([DEFMOD_TOOLS_NAMES],  [(PKG_CONFIG_LIBDIR,PKG_CONFIG_PATH,CFLAGS,CXXFLAGS,LDFLAGS,INCLUDE_PATH,BIN_PATH,LIBRARY_PATH,PATH,CC,CXX,AR,RC,STRIP,RANLIB,LD,CROSS)]) dnl
