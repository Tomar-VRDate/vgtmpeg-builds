...
DEFMOD([gstreamer], [RELEASE-0.10.29], [gstreamer], [git], [$(NL_GIT_BASE_GST)],,,[./autogen.sh --] )
DEFMOD_COPT_ADD([gstreamer], [--enable-gtk-doc=no --disable-loadsave --disable-examples --disable-tests --disable-check --disable-net] )

DEFMOD([gst_plugins_base], [RELEASE-0.10.29], [gst-plugins-base], [git], [$(NL_GIT_BASE_GST)],,[--enable-gtk-doc=no], [./autogen.sh --]  )
DEFMOD([gst_plugins_good], [RELEASE-0.10.22], [gst-plugins-good], [git], [$(NL_GIT_BASE_GST)],,[--enable-gtk-doc=no --disable-shout2], [./autogen.sh --] )
