...
get_and_build libiconv $libiconv_version
get_and_build gettext  $gettext_version 
get_and_build glib     $glib_version 
get_and_build libxml2  $libxml2_version "--without-python" 
