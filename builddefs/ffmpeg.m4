...
ifeq ($(buildtype),windows-x86_32)
	FFMPEG_CONFIGURE_BASE_OPT +=  --enable-pthreads --arch=i386 --enable-cross-compile --target-os=mingw32 --cross-prefix=$(tools_prefix) --enable-memalign-hack  --extra-cflags=-DPTW32_STATIC_LIB
...
DEFMOD([ffmpeg],[master], [ffmpeg], [git], [$(BB_GIT_BASE)] )
