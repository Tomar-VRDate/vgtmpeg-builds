...
DEFMOD_MAKECMD([xvid],[$(MAKE) xvidcore.a])
DEFMOD_INSTCMD([xvid],[install -m 644 =build/xvidcore.a $(prefix)/lib/libxvidcore.a; install -m 644 ../../src/xvid.h $(prefix)/include/xvid.h])    
