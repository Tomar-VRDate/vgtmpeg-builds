...
DEFMOD_INSTCMD([xvid],[mkdir -p $(prefix)/lib; mkdir -p $(prefix)/include; install -m 644 =build/$(XVID_STATIC_LIB) $(prefix)/lib/libxvidcore.a; install -m 644 ../../src/xvid.h $(prefix)/include/xvid.h])    
