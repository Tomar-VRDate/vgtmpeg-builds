LIBDVDREAD_PACKAGE_NAME=libdvdread
LIBDVDREAD_VERSION = master
LIBDVDREAD_BASE = BB_GIT_BASE
LIBDVDREAD_SRC_BASE = libdvdread
...
DEFMOD([$(LIBDVDREAD_PACKAGE_NAME)],[$(LIBDVDREAD_VERSION)],[$(LIBDVDREAD_SRC_BASE)],[$(LIBDVDREAD_GET_TYPE)],[$(BB_GIT_BASE)],[$(LIBDVDREAD_COPT)])
