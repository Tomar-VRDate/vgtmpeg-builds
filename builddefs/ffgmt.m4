...
DEFMOD_COPT_ADD([ffmpeg], [--enable-gpl --enable-nonfree --enable-libx264 --enable-libfaac --disable-muxers --enable-muxer=mp4 --disable-encoders --enable-encoder=libfaac --enable-encoder=libx264 --enable-encoder=mpeg4 ] )
